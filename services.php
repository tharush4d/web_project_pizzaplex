...
<head>
    ...
    <title>Pizza Plex - Service</title>
...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark navbar-transparent fixed-top">
  ...
  <section class="services-section py-5">
    <div class="container">
      <h1 class="text-center mb-5">Our Services – Made to Delight</h1>
  
      <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
              <div class="card h-100 text-center shadow service-card">

                  <div class="card-body">
                    <div class="service-icon-wrapper mb-3">
                      <i class="fas fa-truck fa-3x text-primary mb-3"></i> 
                    </div>
                      <h5 class="card-title">Fast Delivery Service</h5>
                      <p class="card-text text-muted small">
                        Get your pizza hot and fresh – right to your doorstep!
                        We offer speedy and reliable delivery within selected areas.
                      </p>
                  </div>
              </div>
          </div>
               ...
               <div class="card h-100 text-center shadow service-card">
                  <div class="card-body">
                    <div class="service-icon-wrapper mb-3">
                      ...
                      <h5 class="card-title">Easy Takeaway Option</h5>
                      <p class="card-text text-muted small">
                        Pick up your order at your convenience.
                        Order online or by phone and grab it on the go!
                      </p>
                  </div>
              </div>
          </div>
               ...
               <div class="card h-100 text-center shadow service-card">
                  <div class="card-body">
                    <div class="service-icon-wrapper mb-3">
                       ...
                       <h5 class="card-title">Catering for Celebrations</h5>
                      <p class="card-text text-muted small">
                        Planning a party, birthday, or special event?
                        We’re ready to serve delicious pizzas and more for your next big occasion!
                      </p>
                  </div>
              </div>
          </div>
